	...
	return (
		<View>
			...
			<View className='flex items-end'>
        		<Text className='text-sm font-bold mt-7 mr-12'>Dough: ${userAmount}</Text>
      		</View>
			...
			<View className='flex items-center mt-12'>
				<View style={{ flexDirection: "row" }}>
					...
					<View className='items-center ' style={{ backgroundColor: "green", width: 100, height: 100 }}>
						<Text className='text-2xl font-bold mt-8 text-white'>{text1}</Text>
					</View>
					<View className='items-center' style={{ backgroundColor: "red", width: 100, height: 100 }}>
						<Text className='text-2xl font-bold mt-8 text-white'>{text2}</Text>
					</View>
					<View className='items-center'style={{ backgroundColor: "yellow", width: 100, height: 100 }}>
			...
			<View className='flex items-center'>
        		<Text className='text-sm font-bold mt-7 mr-12'>Current Bet: ${count}</Text>
      		</View>
			...
			<View className='flex items-center mt-12'>
				<View className='gap-4' style={{ flexDirection: "row" }}>
					<View className='items-center rounded-full border-2 border-green-900'
					 style={{ backgroundColor: "green", width: 80, height: 50 }}>
						<Text className='text-4xl font-bold mt-1 text-white' onPress={() => increaseBetAmountBy(1)}>$1</Text>
					</View>
					<View className='items-center rounded-full border-2 border-red-900'
					 style={{ backgroundColor: "red", width: 80, height: 50 }}>
						<Text className='text-4xl font-bold mt-1 text-white' onPress={() => increaseBetAmountBy(5)}>$5</Text>
					</View>
					<View className='items-center rounded-full border-2 border-orange-500' 
					 style={{ backgroundColor: "orange", width: 80, height: 50 }}>
						<Text className='text-4xl font-bold mt-1 text-white' onPress={() => increaseBetAmountBy(10)}>$10</Text>
					</View>
					<View className='items-center rounded-full border-2 border-blue-900' 
					 style={{ backgroundColor: "blue", width: 80, height: 50 }}>
						<Text className='text-4xl font-bold mt-1 text-white' onPress={() => increaseBetAmountBy(50)}>$50</Text>
					</View>
				</View>
			</View>
